...
const stats = ref([
    { label: '总用户数', value: '1,234', icon: 'pi pi-users', color: 'bg-blue-500' },
    { label: '菜品总数', value: '567', icon: 'pi pi-book', color: 'bg-emerald-500' },
    { label: '今日推荐', value: '89', icon: 'pi pi-thumbs-up', color: 'bg-amber-500' },
    { label: '本周计划', value: '234', icon: 'pi pi-calendar', color: 'bg-purple-500' },
])
...
function initRecipeChart() {
    const chart = echarts.init(document.getElementById('recipeChart')!)
    chart.setOption({
